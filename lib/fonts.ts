import { Bebas_Neue, Grand_Hotel, Gugi, Poppins, Rajdhani, Righteous, Passion_One, Quando, Odor_Mean_Chey } from "next/font/google";
...
//==== BOOZE BITES ====//
export const quando = Quando({ weight: ["400"], subsets: ['latin'] });
export const odor = Odor_Mean_Chey({ weight: ["400"], subsets: ['latin'] });
export const passion = Passion_One({ weight: ["400", "700", "900"], subsets: ['latin'] });